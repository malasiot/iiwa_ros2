...
def generate_launch_description():
    ...
    delay_left_robot_controller_spawner_after_joint_state_broadcaster_spawner = RegisterEventHandler(
        event_handler=OnProcessExit(
            target_action=joint_state_broadcaster_spawner,
            on_exit=[left_robot_controller_spawner],
        )
    )
    
    delay_right_robot_controller_spawner_after_joint_state_broadcaster_spawner = RegisterEventHandler(
        event_handler=OnProcessExit(
            target_action=joint_state_broadcaster_spawner,
            on_exit=[right_robot_controller_spawner],
        )
    )
    ...
    nodes = [
        ...
        delay_left_robot_controller_spawner_after_joint_state_broadcaster_spawner,
        delay_right_robot_controller_spawner_after_joint_state_broadcaster_spawner,
    ]
